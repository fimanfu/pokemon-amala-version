...
#define VAR_LAW_COUNTER                                  0x40F7 // Law Route progress tracker
#define VAR_CHAOS_COUNTER                                0x40F8 // Chaos Route progress tracker
#define VAR_NEUTRAL_COUNTER                              0x40F9 // Neutral Route progress tracker
