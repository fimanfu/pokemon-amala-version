...
enum __attribute__((packed)) Move
{
    ...
    MOVE_CHAOTIC_WILL = 848,
    MOVE_RED_CAPOTE = 849,
    MOVE_MEDITATION = 850,
    MOVE_FREIKUGEL = 851,
    MOVE_DEADLY_FURY = 852,
    MOVE_GAEA_RAGE = 853,
    MOVE_PRAYER = 854,
    MOVE_HELL_BURNER = 855,
    MOVE_TERRORBLADE = 856,
    MOVE_BABYLON_GOBLET = 857,
    MOVE_EVIL_MELODY = 858,
    MOVE_MUDOBARION = 859,
    MOVE_HAMABARION = 860,
    MOVE_AGIBARION = 861,
    MOVE_BUFUBARION = 862,
    ...
    MOVE_PSIOBARION = 868,
    MOVE_MEGIDOLAON = 869,
    MOVE_MEGIDOLADYNE = 870, 
    MOVE_MORNING_STAR = 871,
    MOVE_GIGANTOMACHIA = 872,
    MOVE_MEDIARAHAN = 873,
    MOVE_LUSTER_CANDY = 874,
    MOVE_DEBILITATE = 875,
    MOVE_GAE_BOLG = 876,
    MOVE_CTOPLEASURE = 877,
    MOVE_VSALVATION = 878,
    MOVE_QUEENS_DECREE = 879,
    MOVE_MOTHER_EARTH = 880,
    MOVE_DIE_FOR_ME = 881,
    MOVE_KERAUNOS = 882,
    MOVE_TANDAVA = 883,
    MOVE_FIRE_OF_SINAI = 884,
    MOVE_MARALAGIBARION = 885,
    MOVE_AGI = 886,
    MOVE_AGILAO = 887,
    MOVE_AGIDYNE = 888,
    MOVE_BUFU = 889,
    ...
    MOVE_HAMAON = 913,
    MOVE_BRUTAL_HIT = 914,
    MOVE_MULTI_STRIKE = 915,
    MOVE_DEATHBOUND = 916,
    MOVE_MEGIDO = 917,
    MOVE_MEGIDOLA = 918,
    MOVE_FRIDGE = 919,
    MOVE_PLASMA_DISCHARGE = 920,
    MOVE_FLORAL_GUST = 921,
    MOVE_RAGNAROK = 922,
    MOVE_PANTA_RHEI = 923,
    MOVE_RAPID_QUAKE = 924,
    MOVE_MENTAL_SHAKE = 925,
    MOVE_HAZARD_MELTDOWN = 926,
    MOVE_BLACK_DEATH = 927,
    MOVE_TALISMAN_WALL = 928,
    MOVES_COUNT_MEGATEN,

    MOVES_COUNT = MOVES_COUNT_MEGATEN,
