...
enum __attribute__((packed)) Ability
{
    ...
    // Megaten
    ABILITY_MAGATAMA = 311,
    ABILITY_CRIPPLING_BLOW = 312,
    ABILITY_SOLEMN_VOW = 313,
    ABILITY_SPEED_STAR = 314,
    ABILITY_FOUR_HORSEMEN = 315,
    ABILITY_SEVEN_HEADED_BEAST = 316,
    ABILITY_SEVEN_TRUMPETS = 317,
    ABILITY_DAWN_OF_DEMISE = 318,
    ABILITY_MARAS_MIGHT = 319,
    ABILITY_POISON_OF_GOD = 320,
    ABILITY_ARS_GOETIA = 321,
    ABILITY_REPEL_PHYSICAL = 322,
    ABILITY_FOUR_DEVAS = 323,
    ABILITY_FIRMAMENT = 324,
    ABILITY_MASAKADO = 325,
    ABILITY_NAHOBINO = 326,
    ABILITY_NAHOBINO_2 = 327,
    ABILITY_ALLURE = 328,
    ABILITY_RAVEN_OF_HEAVEN = 329,
    ABILITY_SMIRK = 330,
    ABILITY_ONE_OF_BEL = 331,
    ABILITY_BIONDETTA = 332,
    ABILITY_ALL_FATHER = 333,
    ABILITY_THE_DLC_MONSTER = 334,
    ABILITY_STORM_GOD = 335,
    ABILITY_ARCHANGEL = 336,
    ABILITY_ARBITER = 337,
    ABILITIES_COUNT_MEGATEN,

    ABILITIES_COUNT = ABILITIES_COUNT_MEGATEN,
};
